...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-9">
            <form action="{{ route('recycling.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <span>Doğayi geri dönüştür!</span>
                        <button type="submit" class="btn btn-primary" id="image-upload" style="display: none;">Fotoğrafı Yükle</button>
                    </div>

                    <div class="card-body">
                        <div class="ml-2 col-md-6 justify-content-center>
                    <div id=" msg">Senden geri dönüşümün bir fotoğrafını çekip bizlere göndermeni istiyoruz.</div>
